...
class CalendarHeader extends Component {
  ...
  render() {
    ...
    if (!this.props.hideArrows) {
      leftArrow = (
        <TouchableOpacity
          onPress={this.props.arabic?this.onPressRight:this.onPressLeft}
      ...
      rightArrow = (
        <TouchableOpacity
          onPress={this.props.arabic?this.onPressLeft:this.onPressRight}
          style={this.style.arrow}
          hitSlop={{left: 20, right: 20, top: 20, bottom: 20}}
    ...
    return (
      <View style={this.props.style}>
        ...
        </View>
        {
          ...
          <View style={(this.props.arabic)? this.style.weekAR: this.style.week}>
